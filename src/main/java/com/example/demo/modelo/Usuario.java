...
public class Usuario {
	...
	public Usuario(String nombre_completo, Date fecha_expedicion_licencia, String categoria_licencia,
			Date vigencia_licencia, String correo_electronico, String telefono, String password) {
		super();
